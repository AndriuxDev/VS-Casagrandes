...
-----------------------------------------------------------------------
	...
	--ARTIST 2
	makeLuaText('ARTIST2', 'Wednesday\'s Infidelity Team + Fans', 1000, 132, -1000)
	setTextAlignment('ARTIST2', 'center')
	setTextSize('ARTIST2', 25)
	setObjectCamera('ARTIST2', 'other')
	addLuaText('ARTIST2')

	makeLuaText('ARTIST3', 'Jakeneutron', 1000, 132, -1000)
	...
	makeLuaText('MUSICIAN2', 'Wednesday\'s Infidelity Team + Fans', 1000, 132, -1000)
