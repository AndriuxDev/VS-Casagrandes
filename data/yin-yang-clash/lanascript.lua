...
idle_xml_name = 'Lola idle'
left_xml_name = 'Lola left'
down_xml_name = 'Lola down'
up_xml_name = 'Lola up'
right_xml_name = 'Lola right'
...
name_of_character_xml = 'Lola'
name_of_character = 'Lola'
name_of_notetype = 'lolanote'
name_of_notetype2 = 'both' -- you don't need this, but if you want a notetype that has multiple characters to sing you can use this.
...
function onCreate()
	...
	addAnimationByPrefix(name_of_character, 'idle', idle_xml_name, 18, false);
	addAnimationByPrefix(name_of_character, 'singLEFT', left_xml_name, 18, false);
	addAnimationByPrefix(name_of_character, 'singDOWN', down_xml_name, 18, false);
	addAnimationByPrefix(name_of_character, 'singUP', up_xml_name, 18, false);
	addAnimationByPrefix(name_of_character, 'singRIGHT', right_xml_name, 18, false);
...
function onTimerCompleted(tag)
	if tag == 'returnidlek' then objectPlayAnimation(name_of_character, 'idle')
	end
end
