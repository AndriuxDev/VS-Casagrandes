...
-----------------------------------------------------------------------
	...
	--ARTIST 1
	makeLuaText('ARTIST1', 'AndriuxDev', 1000, 132, -1000)
	setTextAlignment('ARTIST1', 'center')
	setTextSize('ARTIST1', 25)
	setObjectCamera('ARTIST1', 'other')
	addLuaText('ARTIST1')
	
	makeLuaText('ARTIST2', 'Vs Mickey Mouse Team', 1000, 132, -1000)
	...
	--CHARTER 1
	makeLuaText('CHARTER1', 'AndriuxDev', 1000, 132, -1000)
	setTextAlignment('CHARTER1', 'center')
	setTextSize('CHARTER1', 25)
	setObjectCamera('CHARTER1', 'other')
	addLuaText('CHARTER1')
	
	makeLuaText('CHARTER2', 'Jakeneutron', 1000, 132, -1000)
