...
-----------------------------------------------------------------------
	...
	--CODER 1
	makeLuaText('CODER1', 'The VS SONIC.EXE Team', 1000, 132, -1000)
	...
	--CODER 1
	makeLuaText('CODER2', 'AndriuxDev', 1000, 132, -1000)
	...
	--ARTIST 1
	makeLuaText('ARTIST1', 'The VS SONIC.EXE Team', 1000, 132, -1000)
	...
	--ARTIST 2
	makeLuaText('ARTIST2', 'Gato Arabe', 1000, 132, -1000)
	...
	addLuaText('ARTIST2')
		...
		--ARTIST 2
	makeLuaText('ARTIST2', 'AndriuxDev', 1000, 132, -1000)
	setTextAlignment('ARTIST2', 'center')
	setTextSize('ARTIST2', 25)
	setObjectCamera('ARTIST2', 'other')
	addLuaText('ARTIST2')
	...
	makeLuaText('MUSICIAN2', 'The VS SONIC.EXE Team', 1000, 132, -1000)
	...
	--CHARTER 1
	makeLuaText('CHARTER1', 'The VS SONIC.EXE Team', 1000, 132, -1000)
