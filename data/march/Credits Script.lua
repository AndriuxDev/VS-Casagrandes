...
-----------------------------------------------------------------------
	...
	--ARTIST 1
	makeLuaText('ARTIST1', 'Gato Arabe', 1000, 132, -1000)
	...
	--ARTIST 2
	makeLuaText('ARTIST2', 'VS Jenny Team', 1000, 132, -1000)
	setTextAlignment('ARTIST2', 'center')
	setTextSize('ARTIST2', 25)
	setObjectCamera('ARTIST2', 'other')
	addLuaText('ARTIST2')
	
	makeLuaText('ARTIST3', 'AndriuxDev', 1000, 132, -1000)
	...
	--CHARTER 1
	makeLuaText('CHARTER1', 'VS Homr Team', 1000, 132, -1000)
	setTextAlignment('CHARTER1', 'center')
	setTextSize('CHARTER1', 25)
	setObjectCamera('CHARTER1', 'other')
	addLuaText('CHARTER1')

	makeLuaText('CHARTER2', 'AndriuxDev', 1000, 132, -1000)
