...
function onCreate()
	if not hideHud then
		...
		loadGraphic('icon3', 'icons/icon-velc', 150)
		addAnimation('icon3', 'icons/icon-velc', {0, 1}, 0, true)
		addAnimation('icon3', 'icons/icon-velc', {1, 0}, 0, true)
	...
	if not hideHud then
		...
		loadGraphic('icon4', 'icons/icon-velmas', 150)
		addAnimation('icon4', 'icons/icon-velmas', {0, 1}, 0, true)
		addAnimation('icon4', 'icons/icon-velmas', {1, 0}, 0, true)
